...
export class BasketService {
  ...
  getBasket(username: string){
    return this.http.get<IBasket>(this.baseUrl+'/Basket/GetBasket/sahaja').subscribe({
  ...
  private createBasket(): Basket {
    ...
    localStorage.setItem('basket_username', 'sahaja'); //TODO: sahaja can be replaced with LoggedIn User
    return basket;
  }
