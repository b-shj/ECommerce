...
namespace Ordering.Infrastructure.Extensions
{
    public static class InfraServices
    {
        ...
        {
            serviceCollection.AddDbContext<OrderContext>(options => options.UseSqlServer(configuration.GetConnectionString("OrderingConnectionString"), sqlServerOptions => sqlServerOptions.EnableRetryOnFailure()));
